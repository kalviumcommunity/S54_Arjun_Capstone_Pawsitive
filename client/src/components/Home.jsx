  ...
  return (
    <>
      ...
      <Box display='flex' flexDirection={{ base: 'column', md: 'row' }} p={{ base: '3vw', md: '2rem' }}>
        ...
        <Box display='flex' flexDirection='column' alignItems="center" justifyContent="center" textAlign='left' p={{ base: '5vw', md: '3vw' }}>
          <Heading size={{ base: '2xl', md: '3xl' }} fontWeight='bold' mb={{ base: '1rem', md: '2rem' }}>Welcome to Pawsitive where we spread <Heading size={{ base: '2xl', md: '3xl' }} className='paytone-one-regular' id='yellow'>Pawsitivity :)</Heading> </Heading>
